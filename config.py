...
print("config.py: C:\\Users\\DanLa\\Documents\\github\\thousand_miles\\toolkit\\ToS_gui_survey\\config.py")
...
class WindowConfig:
    ...
    TARGET_FOLDER: str = os.getenv("TARGET_FOLDER", r"\\MASTERBOT\scans")

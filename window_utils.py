...
from mb_tools.windowing import (
    find_window_by_title_prefix as mb_find_window_by_title_prefix,
    is_widget_window_visible,
    bring_widget_window_to_front,
    update_root_window_positions as mb_update_root_window_positions,
)
...
def find_window_by_title_prefix(title_prefix: str):
    """
    Project-local wrapper around mb_tools.windowing.find_window_by_title_prefix.

    Kept so ToS_gui_survey code can continue importing from window_utils.
    """
    return mb_find_window_by_title_prefix(title_prefix)
...
def is_window_visible(widget_name, widget_stacks, title_map) -> bool:
    return is_widget_window_visible(widget_name, widget_stacks, title_map)
...
def bring_window_to_front(
    ...
    return bring_widget_window_to_front(
        widget_name,
        widget_stacks,
        title_map,
        logger=logger,
...
def update_root_window_positions(
    ...
    *,
    ...
    """
    Project-local wrapper around mb_tools.windowing.update_root_window_positions.

    Keeps existing ToS_gui_survey imports working while the reusable
    implementation lives in mb_tools.
    """
    mb_update_root_window_positions(
        widget_stacks,
        title_map,
        logger=logger,
